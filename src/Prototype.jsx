...
const sampleProducts = [
  // Drinks
  { name: "Flat White", price: "4.50", fav: true, cat: "Drinks", image: "/products/flat-white.png" },
  { name: "Cappuccino", price: "4.80", fav: true, cat: "Drinks", image: "/products/cappuccino.png" },
  { name: "Long Black", price: "4.00", fav: false, cat: "Drinks", image: "/products/long-black.png" },
  { name: "Chai Latte", price: "5.20", fav: false, cat: "Drinks", image: "/products/chai-latte.png" },
  { name: "Lemon Squash", price: "3.50", fav: false, cat: "Drinks", image: "/products/lemon-squash.png" },
  { name: "Matcha Latte", price: "5.80", fav: false, cat: "Drinks", image: "/products/matcha-latte.png" },
  { name: "Iced Coffee", price: "5.50", fav: true, cat: "Drinks", image: "/products/iced-coffee.png" },
  { name: "Hot Chocolate", price: "4.50", fav: false, cat: "Drinks", image: "/products/hot-chocolate.png" },
  { name: "Fresh OJ", price: "6.00", fav: false, cat: "Drinks", image: "/products/fresh-oj.png" },
  { name: "Espresso", price: "3.50", fav: false, cat: "Drinks", image: "/products/espresso.png" },
  // Food
  { name: "Blueberry Muffin", price: "5.50", fav: true, cat: "Food", image: "/products/blueberry-muffin.png" },
  { name: "Banana Bread", price: "6.00", fav: false, cat: "Food", image: "/products/banana-bread.png" },
  { name: "Croissant", price: "4.50", fav: false, cat: "Food", image: "/products/croissant.png" },
  { name: "Avo Toast", price: "14.00", fav: false, cat: "Food", image: "/products/avo-toast.png" },
  { name: "Eggs Benny", price: "16.50", fav: true, cat: "Food", image: "/products/eggs-benny.png" },
  { name: "Acai Bowl", price: "15.00", fav: false, cat: "Food", image: "/products/acai-bowl.png" },
  { name: "Granola Bowl", price: "12.00", fav: false, cat: "Food", image: "/products/granola-bowl.png" },
  { name: "BLT Sandwich", price: "11.50", fav: false, cat: "Food", image: "/products/blt-sandwich.png" },
  { name: "Caesar Salad", price: "13.00", fav: false, cat: "Food", image: "/products/caesar-salad.png" },
  { name: "Chicken Wrap", price: "12.50", fav: true, cat: "Food", image: "/products/chicken-wrap.png" },
];
