      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "32px 32px 64px" }}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12, fontSize: tokens.type.bodyMedium.size, color: tokens.color.fg.emphasis, lineHeight: "1.6" }}>
            ...
            <div><strong style={{ color: tokens.color.fg.brand }}>PaymentScreen</strong> — CBA Smart Hospitality–inspired payment option selector. Three prominent cards: Pay in Full, Split by Item, Split Equally. Uses custom Composables with <code style={{ background: tokens.color.bg.surface, padding: "2px 6px", borderRadius: 4 }}>ElevatedCard</code> and <code style={{ background: tokens.color.bg.surface, padding: "2px 6px", borderRadius: 4 }}>NavigableItem</code>.</div>
            <div><strong style={{ color: tokens.color.fg.brand }}>SplitByItemScreen</strong> — Checkbox-based item selector with progress bar. Maps to <code style={{ background: tokens.color.bg.surface, padding: "2px 6px", borderRadius: 4 }}>LazyColumn</code> with <code style={{ background: tokens.color.bg.surface, padding: "2px 6px", borderRadius: 4 }}>Checkbox</code> and <code style={{ background: tokens.color.bg.surface, padding: "2px 6px", borderRadius: 4 }}>LinearProgressIndicator</code>. Multi-round payment processing.</div>
            <div><strong style={{ color: tokens.color.fg.brand }}>SplitEquallyScreen</strong> — Patron count stepper with visual payment progress circles. Uses <code style={{ background: tokens.color.bg.surface, padding: "2px 6px", borderRadius: 4 }}>NumberPicker</code> pattern and <code style={{ background: tokens.color.bg.surface, padding: "2px 6px", borderRadius: 4 }}>FlowRow</code> for patron circle indicators.</div>
            <div><strong style={{ color: tokens.color.fg.brand }}>PaymentProcessingScreen</strong> — Animated tap-to-pay flow with three stages: waiting (NFC pulse rings), processing (spinner), approved (check animation). Includes receipt options (Print/Digital QR).</div>
          </div>
        </Section>
      </div>
    </div>
